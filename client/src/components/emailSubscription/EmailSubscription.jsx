    ...
    return (
        <div className="bg-gray-900 text-white p-8 pb-0 mt-4">
            ...
            <form className="flex justify-center space-y-4 space-x-4 w-full">
                ...
                <input type="email" id="email" name="email" placeholder="Enter your email address" className="w-52 border-gray-300 rounded-full shadow-sm py-2 px-3 focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm" />
